...
myGabor_real =  createGauss(rot_x, rot_y, gamma, sigma)*cosCarrier;
myGabor_imaginary = createGauss(rot_x, rot_y, gamma, sigma)*sinCarrier;
...
gaussEnv = exp(-((rot_x).^2 + gamma*(rot_y).^2)/(2*sigma^2));
